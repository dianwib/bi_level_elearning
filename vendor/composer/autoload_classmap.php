...
return array(
    ...
    'M_At_risk' => $baseDir . '/application/models/M_At_risk.php',
    'M_Course' => $baseDir . '/application/models/M_Course.php',
    'M_Course_Assesment' => $baseDir . '/application/models/M_Course_Assesment.php',
    'M_Course_Assesment_Question' => $baseDir . '/application/models/M_Course_Assesment_Question.php',
    'M_Course_Assesment_Question_Answer' => $baseDir . '/application/models/M_Course_Assesment_Question_Answer.php',
    'M_Course_Assesment_Question_Answer_Of_Student' => $baseDir . '/application/models/M_Course_Assesment_Question_Answer_Of_Student.php',
    'M_Course_Assesment_Result' => $baseDir . '/application/models/M_Course_Assesment_Result.php',
    'M_Course_Assignment' => $baseDir . '/application/models/M_Course_Assignment.php',
    'M_Course_Assignment_Submission' => $baseDir . '/application/models/M_Course_Assignment_Submission.php',
    'M_Course_Assignment_loc' => $baseDir . '/application/models/M_Course_Assignment_loc.php',
    'M_Course_Category' => $baseDir . '/application/models/M_Course_Category.php',
    'M_Course_Content' => $baseDir . '/application/models/M_Course_Content.php',
    'M_Course_Enrol' => $baseDir . '/application/models/M_Course_Enrol.php',
    'M_Course_Enrol_Detail' => $baseDir . '/application/models/M_Course_Enrol_Detail.php',
    'M_Course_Forum' => $baseDir . '/application/models/M_Course_Forum.php',
    'M_Course_Forum_Thread' => $baseDir . '/application/models/M_Course_Forum_Thread.php',
    'M_Course_Forum_Thread_Reply' => $baseDir . '/application/models/M_Course_Forum_Thread_Reply.php',
    'M_Course_Forum_Thread_Reply_Reply' => $baseDir . '/application/models/M_Course_Forum_Thread_Reply_Reply.php',
    'M_Course_Forum_Thread_Reply_Reply_Reply' => $baseDir . '/application/models/M_Course_Forum_Thread_Reply_Reply_Reply.php',
    'M_Course_Forum_User' => $baseDir . '/application/models/M_Course_Forum_User.php',
    'M_Course_Learning_Outcomes' => $baseDir . '/application/models/M_Course_Learning_Outcomes.php',
    'M_Course_Lesson' => $baseDir . '/application/models/M_Course_Lesson.php',
    'M_Hasil_Kuesioner' => $baseDir . '/application/models/M_Hasil_Kuesioner.php',
    'M_Hasil_Kuesioner2' => $baseDir . '/application/models/M_Hasil_Kuesioner2.php',
    'M_Learning_Goal' => $baseDir . '/application/models/M_Learning_Goal.php',
    'M_Learning_Style' => $baseDir . '/application/models/M_Learning_Style.php',
    'M_Lesson_Access_Log' => $baseDir . '/application/models/M_Lesson_Access_Log.php',
    'M_Log' => $baseDir . '/application/models/M_Log.php',
    'M_Notification' => $baseDir . '/application/models/M_Notification.php',
    'M_Rating_Reply' => $baseDir . '/application/models/M_Rating_Reply.php',
    'M_Rating_Reply_Reply' => $baseDir . '/application/models/M_Rating_Reply_Reply.php',
    'M_Rating_Reply_Reply_Reply' => $baseDir . '/application/models/M_Rating_Reply_Reply_Reply.php',
    'M_Rating_Thread' => $baseDir . '/application/models/M_Rating_Thread.php',
    'M_University' => $baseDir . '/application/models/M_University.php',
    'M_User' => $baseDir . '/application/models/M_User.php',
    'M_login' => $baseDir . '/application/models/M_login.php',
